(function () {
  const CATEGORY_KEYS = ['celine', 'shakira', 'enrique', 'dance', 'classics', 'football', 'pele', 'maradona', 'messi', 'messigear', 'ronaldo', 'cruyff', 'zidane', 'ronaldinho', 'r9', 'vanbasten', 'beckenbauer', 'oscar_songs', 'musical_films', 'classic_themes', 'movie_dance', 'romantic_moments', 'web_series', 'hindi_web_series', 'hindi_movies', 'bengali_movies', 'malayalam_dance_ladies', 'malayalam_movies', 'jubin_nautiyal', 'raabta', 'arijit_singh', 'atif_aslam', 'rubaru', 'aesthetic_colourful', 'sher_shayari_party', 'sufi_party', 'ghazal_party', 'mere_rashke_qamar', 'party_anthems', 'punjabi_songs', 'dosti', 'soulful', 'punjabi_dance_ladies', 'punjabi_dance', 'tt_gear', 'tt_players', 'tt_legends', 'tt_styles', 'tt_matches', 'tennis_aces', 'tennis_dtl', 'tennis_crosscourt', 'tennis_single_dtl', 'tennis_single_crosscourt', 'bike_secondhand', 'bike_customization', 'bike_enhancements', 'bike_gear', 'bike_repairs', 'playlist', 'love', 'african', 'latin', 'flamenco'];
  const BADGE_MAP = {
    ...
    aesthetic_colourful: 'badge-indian', sher_shayari_party: 'badge-indian', sufi_party: 'badge-indian', ghazal_party: 'badge-indian', mere_rashke_qamar: 'badge-indian', party_anthems: 'badge-indian', punjabi_songs: 'badge-indian', dosti: 'badge-indian', soulful: 'badge-indian', punjabi_dance_ladies: 'badge-indian', punjabi_dance: 'badge-indian',
